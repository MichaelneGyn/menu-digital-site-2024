...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.restaurantName || !formData.email || !formData.password || !formData.whatsapp) {
    ...
    if (emailDomain && BLOCKED_DOMAINS.includes(emailDomain)) {
      toast.error('Use um e-mail corporativo ou pessoal valido (Gmail, Hotmail etc).');
      return;
    }
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="mb-10">
            <Link href="/" className="flex items-center gap-2 mb-8 group">
              ...
              <span className="font-bold text-xl text-gray-900">Virtual Cardapio</span>
            </Link>

            <h2 className="text-3xl font-bold text-gray-900 mb-2">Comece Gratis</h2>
            <p className="text-gray-500">
              Crie seu cardapio digital em menos de 1 minuto.
              <br />
              <span className="text-primary font-semibold">Sem cartao de credito.</span>
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <Label htmlFor="name" className="text-sm font-semibold text-gray-700">Seu nome</Label>
              <div className="mt-1">
                <Input
                  id="name"
                  name="name"
            ...
            <div>
              <Label htmlFor="restaurantName" className="text-sm font-semibold text-gray-700">Nome do restaurante</Label>
              <div className="mt-1">
                <Input
                  id="restaurantName"
                  name="restaurantName"
            ...
            <div>
              <Label htmlFor="whatsapp" className="text-sm font-semibold text-gray-700">WhatsApp do negocio</Label>
              <div className="mt-1">
                <Input
                  id="whatsapp"
                  name="whatsapp"
            ...
            <div>
              <Label htmlFor="email" className="text-sm font-semibold text-gray-700">Seu melhor email</Label>
              <div className="mt-1">
                <Input
                  id="email"
                  name="email"
            ...
            <div>
              <Label htmlFor="password" className="text-sm font-semibold text-gray-700">Crie uma senha</Label>
              <div className="mt-1">
                <Input
                  id="password"
                  name="password"
      ...
      <div className="hidden lg:flex flex-1 relative bg-slate-50 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <div className="absolute bottom-40 -left-10 bg-white p-4 rounded-xl shadow-xl border border-gray-100 animate-pulse">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 font-bold">30%</div>
              <div>
                <p className="font-bold text-gray-900">Mais Vendas</p>
                <p className="text-xs text-gray-500">Com cardapio digital</p>
              </div>
            </div>
          </div>
        </div>
